...
RSpec.feature 'Feature test: create user profile', type: :feature do
	...
	scenario 'newly created user is directed to complete their profile' do
		...
		fill_in 'user_skills_attributes_0_title', with: 'Ruby on Rails developer'
		fill_in 'user_skills_attributes_0_description', with: "I'm a professional Ruby on Rails developer with over eight years experience"
		...
		expect(@user.skills.last.title).to eq "Ruby on Rails developer"
		expect(@user.skills.last.description).to eq "I'm a professional Ruby on Rails developer with over eight years experience"
	end
